...
REM Шаг 1: Проверка и запуск Docker Compose
...
REM Шаг 3: Сборка order-service (продюсер)
...
REM Шаг 4: Сборка notification-service (консьюмер)
...
REM Шаг 5: Создание папки apps и копирование jar
...
REM Шаг 6: Запуск E2E тестов
echo [6] Запуск E2E тестов...
cd %E2E_DIR%
call mvn clean test
set TEST_RESULT=%errorlevel%

REM Завершение: остановка Kafka (опционально)
